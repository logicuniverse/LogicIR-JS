...
2. [workflow/process.md](../workflow/process.md): 当前开发流程、AI task 边界、review/promotion 规则。
3. [planning/roadmap.md](../planning/roadmap.md): 当前确定路线。
4. [theory/schema-principles.md](../theory/schema-principles.md): core/schema/projection 约束。
5. [theory/operational-theory.md](../theory/operational-theory.md): 工程化理论摘要。
6. [theory/logicir-architecture.md](../theory/logicir-architecture.md): profile、stack、provider、
   execution 等生态术语。
...
- [`dev/changes/`](../changes/) 已收窄为人类粗粒度 review/decision 记录；默认只需要 `review.md`。
