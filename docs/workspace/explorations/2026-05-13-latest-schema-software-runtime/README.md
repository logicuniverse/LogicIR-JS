...
```powershell
.\node_modules\.bin\tsc.cmd --strict --noEmit --target ES2022 --module ESNext --moduleResolution node packages\core\src\types.ts packages\architecture\src\types.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\architecture\software-runtime-architecture.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\runtime\software-runtime.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\examples\software-runtime-examples.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\smoke.ts
```
