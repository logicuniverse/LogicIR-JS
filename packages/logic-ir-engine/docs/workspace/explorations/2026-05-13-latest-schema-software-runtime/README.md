...
- `schema/core/v0-draft/types.ts` is the source for LogicIR object shape.
- `schema/architecture/v0-draft/types.ts` is the source for feature, profile,
  stack, provider contract, and binding definition shapes.
...
```powershell
.\node_modules\.bin\tsc.cmd --strict --noEmit --target ES2022 --module ESNext --moduleResolution node schema\core\v0-draft\types.ts schema\architecture\v0-draft\types.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\architecture\software-runtime-architecture.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\runtime\software-runtime.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\examples\software-runtime-examples.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\smoke.ts
```
...
.\node_modules\.bin\tsc.cmd --target ES2020 --module CommonJS --moduleResolution node --strict --outDir $out schema\core\v0-draft\types.ts schema\architecture\v0-draft\types.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\architecture\software-runtime-architecture.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\runtime\software-runtime.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\examples\software-runtime-examples.ts docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\smoke.ts
node (Join-Path $out 'docs\workspace\explorations\2026-05-13-latest-schema-software-runtime\smoke.js')
```
