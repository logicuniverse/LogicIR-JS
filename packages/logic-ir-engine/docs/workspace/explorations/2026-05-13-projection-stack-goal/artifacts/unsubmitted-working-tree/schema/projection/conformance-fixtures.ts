...
import type { ProjectorTarget } from './types';

export type ConformancePositiveFixture = {
  target: ProjectorTarget;
  name: string;
};

export type ConformanceDiagnosticFixture = ConformancePositiveFixture & {
  code: string;
};

export const expectedConformanceTargets: ProjectorTarget[] = [
  'core-validator',
  'type-system',
  'js-runtime',
  'python-runtime',
...
export const positiveConformanceFixtures: ConformancePositiveFixture[] = [
  {
...
export const diagnosticConformanceFixtures: ConformanceDiagnosticFixture[] = [
  {
    target: 'core-validator',
...
export const unsupportedRequiredConformanceFixtures: ConformanceDiagnosticFixture[] = [
  {
    target: 'core-validator',
...
export const coreValidationPlannerConformanceFixtures: ConformanceDiagnosticFixture[] = [
  {
    target: 'js-runtime',
